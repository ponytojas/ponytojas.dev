...
I'm **Daniel**. I build software that holds up in the real world.
...
And yes, I still answer to <RotatingTooltipText
  text="two bunnies"
  images={[
    ...
    "/otis-min/photo1.webp"
  ]}
/> who run the household. I just pay the rent.
