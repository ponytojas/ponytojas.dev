...
<div className='flex flex-col justify-center items-center my-8'>
    <Image src="/projects/utwin/overview.webp" alt="U-TWIN overview. The app shows a map with route, lines and stops for public traffic system" width={600} height={300} />
...
<div className='flex flex-col justify-center items-center my-8'>
    <Image src="/projects/utwin/stop.webp" alt="The app shows a map and a sidebar on the left with all the information regarding a public transport stop" width={600} height={300} />
...
<div className='flex flex-col justify-center items-center my-8'>
    <Image src="/projects/utwin/traffic.webp" alt="The app shows a map with lines and icons. Lines indicate the traffic level and icons identify incidents on the road" width={600} height={300} />
...
<div className='flex flex-col justify-center items-center my-8'>
    <Image src="/projects/utwin/hex.webp" alt="The app shows a map with hexagons of different colors on it" width={600} height={300} />
