...
<div className='flex flex-col justify-center items-center my-8'>
    <Image src="/projects/uneed/arcs.webp" alt="The app shows a map with arcs representing travel flows between public transport stops" width={600} height={300} />
...
<div className='flex flex-col justify-center items-center my-8'>
    <Image src="/projects/uneed/services.webp" alt="The app shows a map with different services. The mouse is over one of them that shows information about the Valencia's university" width={600} height={300} />
...
<div className='flex flex-col justify-center items-center my-8'>
    <Image src="/projects/uneed/select.webp" alt="The app shows modal menu where the user could select different layers" width={600} height={300} />
...
<div className='flex flex-col justify-center items-center my-8'>
    <Image src="/projects/uneed/buffer.webp" alt="The app shows a map with bus stops as buffered circles" width={600} height={300} />
...
<div className='flex flex-col justify-center items-center my-8'>
    <Image src="/projects/uneed/coverage.webp" alt="The app shows a map with some parts of it mark as coverage and some other as not" width={600} height={300} />
